...
describe("BookRepositoryMemory.search", () => {
	...
	const books: Book[] = [
		...
		{
			id: "234e4567-e49b-1fd3-a4e4-445523174213",
			title: "Test Book 4: The Last One",
		},
		{
			id: "444e4567-ed9b-1fd3-a4e4-443322174213",
			title: "Test Book 5: New World",
		},
	];
	...
	it("filters by partial title (case-insensitive)", async () => {
		...
		expect(titles).toEqual(
			expect.arrayContaining([
				"Test Book 1: The Prologue",
				"Test Book 4: The Last One",
			]),
		);
	});
	...
	it("sorts by title ascending/descending", async () => {
		...
		expect(titlesAsc).toEqual([
			"Test Book 1: The Prologue",
			"Test Book 2",
			"Test Book 3: Electric Boogaloo",
			"Test Book 4: The Last One",
			"Test Book 5: New World",
		]);
		expect(titlesDesc).toEqual([
			"Test Book 5: New World",
			"Test Book 4: The Last One",
			"Test Book 3: Electric Boogaloo",
			"Test Book 2",
